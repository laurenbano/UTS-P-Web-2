...
if(isset($_GET['id_mhs'])) $vidmhs =$_GET['id_mhs'];
else $vidmhs ='';
...
if ($vupdate=="update"){
    ...
    header('location: matkul.php', true, 301);
    $rows = $matkul->tampil();
    $vid ='';
    $vmatkul ='';
    $vsks ='';
...
<table>
    ...
    <input type="hidden" name="idmhs" value="<?php echo $vidmhs; ?>" />
        <input type="hidden" name="id" value="<?php echo $vid; ?>" />
        <input type="text" name="matkul" value="<?php echo $vmatkul; ?>" /></td></tr>
    ...
    <?php foreach ($rows as $row) { ?>
        <tr>
            ...
            <td><a href="?id=<?php echo $row['id']; ?>&aksi=hapus">Hapus</a>&nbsp;&nbsp;&nbsp;
                <a href="?id=<?php echo $row['id']; ?>&idm=<?php echo $row['id_mhs']; ?>&aksi=lihat_update">Update</a>
                &nbsp;&nbsp;&nbsp;</td>
        </tr>
    <?php } ?>
 </table>
